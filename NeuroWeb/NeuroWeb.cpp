...
int main()
{
	...
	SetConsoleCP(1251);
	string ans;
	cout << "-------------***Многослойный персептрон***-------------\n";
	while (true) {
		cout << "Обучить нейросеть готовым заданиям (OR, AND, XOR) - 1\nОбучить своему заданию - 2. Выйти из программы - 3\n";
		cout << "Ваш выбор: "; cin >> ans;
		while (!(ans == "1" || ans == "2" || ans == "3")) {
			cout << "Обучить нейросеть готовыми заданиями (OR, AND, XOR) - 1\n Обучить своему заданию - 2. Выйти из программы - 3\n"; cout << "Ваш выбор: "; cin >> ans;
		}
		if (ans == "3") return 0;
		if (ans == "1") {
			cout << "Многослойный персептрон: 3 слоя\n2 нейрона - 16 нейронов - 1 нейрон\nЭпох: 1000\nСкорость обучения: 0.01\n";
			vector<int> config;
			read_conf(config);
			string a; int l;
			...
			cout << "Введите 0, если хотите начать с рандомными весами. Введите 1, если хотите начать c сохраненными весами.\nВведите 2, если хотите выйти из программы.\n"; cout << "Ваш выбор: "; cin >> l;
			while (!cin || cin.peek() != '\n' || !(l == 0 || l == 1 || l == 2)) {
				clean();
				cout << "Введите 0, если хотите начать с рандомных весов. Введите 1, если хотите начать c сохраненными весами.\nВведите 2, если хотите выйти из программы.\n"; cout << "Ваш выбор: "; cin >> l;
			}
			if (l == 2) return 0;
